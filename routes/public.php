...
use App\Http\Controllers\Public\LabController;
...
Route::get('/labs/map', [LabController::class, 'map'])->name('labs-map');
Route::get('/labs/list', [LabController::class, 'list'])->name('labs-list');
Route::get('/lab/{id}', [LabController::class, 'detail'])->name('lab-detail');
Route::get('/lab/{id}/equipment', [LabController::class, 'detailEquipment'])->name('lab-detail-equipment');
