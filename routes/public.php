...
use App\Http\Controllers\Public\LaboratoryController;
use App\Http\Controllers\Public\LaboratoryEquipmentController;
...
Route::get('/labs/map', [LaboratoryController::class, 'map'])->name('labs-map');
Route::get('/labs/list', [LaboratoryController::class, 'list'])->name('labs-list');
Route::get('/lab/{id}', [LaboratoryController::class, 'detail'])->name('lab-detail');
Route::get('/equipment/map', [LaboratoryEquipmentController::class, 'map'])->name('equipment-map');
Route::get('/equipment/list', [LaboratoryEquipmentController::class, 'list'])->name('equipment-list');
Route::get('/lab/{id}/equipment', [LaboratoryEquipmentController::class, 'detail'])->name('lab-detail-equipment');
