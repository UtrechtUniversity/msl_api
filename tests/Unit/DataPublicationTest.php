...
class DataPublicationTest extends TestCase
{
    public function test_from_ckan_array(): void
    {
        ...
        $collection = new FeatureCollection([new Feature(new Polygon([new Point(-60.83408, -51.68212), new Point(-60.83408, -52.13647), new Point(-59.37044, -52.13647), new Point(-59.37044, -51.68212),  new Point(-60.83408, -51.68212)]), ['name' => ''])]);
