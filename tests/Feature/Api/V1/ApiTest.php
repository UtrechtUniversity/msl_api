            ...
            fn (AssertableJson $json) => $json->has('success')
                ...
                ->has(
                    ...
                    fn (AssertableJson $json) => $json
                        ...
                        ->where('downloads.0.downloadLink', route('file-download', ['id' => 'a6434e5f71718999519d775c8239c8a3', 'url' => base64_encode('https://geo.public.data.uu.nl:443/vault-frost-shared/research-frost-shared[1697635081]/original/Original data/')]))
                        ->has('researchAspects')
                        ->etc()
                )
                ->etc()
            ...
            fn (AssertableJson $json) => $json->has('success')
                ...
                ->has(
                    ...
                    fn (AssertableJson $json) => $json
                        ...
                        ->where('downloads.0.downloadLink', route('file-download', ['id' => 'c244d12fef1aba659598ded01699d46e', 'url' => base64_encode('https://geo.public.data.uu.nl:443/vault-nam-groningen-gas-field-ground-motion-model-complete/research-nam-groningen-gas-field-ground-motion-model-complete[1712039436]/original/Field-wide shear-wave velocity and lithology model/')]))
                        ->has('researchAspects')
                        ->etc()
                )
                ->etc()
