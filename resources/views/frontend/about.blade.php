    ...
    <div class="main-content ">
        ...
        <div class="detail-div !bg-primary-100">
            ...
            <div class="detail-entry-div place-items-center !flex-col">
                ...
                <img 
                src= {{ asset('images/heros/about_smallest.png') }}
                alt="aboutImage"
                ...
                <div class="sm:max-w-(--breakpoint-lg) flex md:flex-row flex-wrap sm:p-10 py-10 gap-4 justify-center place-items-center">
                    @foreach ($infoList as $infoElement)
                        <div class="dropdown dropdown-hover p-4">
                            <div tabindex="0" role="button" class="m-1 p-4 bg-base-200 rounded-lg w-64 h-24 place-content-center border-2 border-primary-500 hover:border-info-500"> 
