...
<x-layout_main>
  ...
  <div class="main-content ">
    <div class="detail-div !bg-primary-100 limited-max-width-md">
      ...
      <p class="">Some repositories have specific requirements or data formats/templates to take into account. 
      ...
      <p class="">Wherever you publish, you make it a lot easier for us to find your data by adding keywords from the Multi-Scale Labs vocabularies (the more the better!). 
      ...
      <p class="">…and our job starts. We strive to find your data, and make it findable for others in EPOS MSL, and the EPOS data portal. We do so by looking for data in these data repositories (see Step 1), 
