...
<x-layout_main>
    ...
    <div class="main-content ">
        <div class="detail-div !bg-primary-100 limited-max-width-md">
            ...
            <h1>How to contribute as a researcher</h1>

            <p class="pt-20  text-center">
                Would you like to share Earth scientific laboratory data, or models, from one of the Multi-Scale
            ...
            <p class="">Key is that you publish your data at a repository that can generate <a
                    class="hover-interactive underline" href="https://www.doi.org/">DOI</a>.
            </p>
            <p class="">
                EPOS MSL currently provides access to data at these <a class="hover-interactive underline"
                    href="{{ route('data-repositories') }}">data repositories</a>. The fastest route to make your data
                discoverable by MSL,
                is to publish your data at one of these. Would you like to publish elsewhere? <a
                    class="hover-interactive underline" href="{{ route('contact-us') }}">Let us know!</a>
            ...
            <p class="">
                There may also be best practices available for specific research disciplines within MSL → see the list
                below.
                These can help you optimize the re-usability of your data by others, and therefore increase the impact
                of your data publication.
            </p>
            <p class="pb-8 ">
                Do you know about a best practice relevant for MSL data and models, not listed here? <a
                    class="hover-interactive underline" href="{{ route('contact-us') }}">Let us know!</a>
            </p>
            <div class="">
            ...
            <p class="">Wherever you publish, you make it a lot easier for us to find your data by adding keywords
                from the Multi-Scale Labs vocabularies (the more the better!).
                Here you can explore and select which Multi-Scale Labs keywords apply to your research.
                When you’re done, you can export the keywords you selected, so you know which words to assign when
                you’re making your next data publication.
            </p>
            ...
            <p class="">Would you like to embed MSL vocabularies, or the above keyword selector in the data
                repository you’re affiliated to? You can - it’s all open access and open source.
                Have a look <a class="hover-interactive underline" href="{{ route('contribute-repository') }}">here</a>
                on how to approach this. </p>

            <h2 class="pt-10 pb-4" id="step-4">Step 4: Publish your work
            </h2>
            <p class="">When you publish your data, make sure you do so with an open access license (e.g. <a
                    class="hover-interactive underline" href="https://creativecommons.org/licenses/by/4.0/deed.en">CC BY
                    4.0</a> ).
                Most repositories provide clear guidance on which licenses are useful to provide your data openly, and
                promote citing.
            </p>
            <p class="">Congratulations! Your data is now open access. Your job is done… </p>
            <p class="">…and our job starts. We strive to find your data, and make it findable for others in EPOS
                MSL, and the EPOS data portal. We do so by looking for data in these data repositories (see Step 1),
                that have MSL vocabulary terms (see Step 3) used in the keywords, tags, data descriptions or titles,
                referring to: </p>

            <ul class=" list-disc  pt-6 pb-6 pl-10 pr-10">
                <li>The Earth sciences (i.e. from MSL vocabularies: material, geological setting, or (sub)surface
                    utilization) and </li>
                <li> Laboratories (i.e. terms from a.o. “apparatus”, “measured property” or “analyzed feature” sections
                    of MSL
            ...
            <p class="">Note that we renew this search once or twice per year, meaning that the data you just
                published may not be harvested by MSL for several months. In doubt? Or do you feel we missed your data
                publication?<a class="hover-interactive underline" href="{{ route('contact-us') }}">Let us know!</a></p>
