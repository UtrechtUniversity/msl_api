  ...
  <div class="main-content ">
    <div class="detail-div !bg-primary-100 limited-max-width-md">
      ...
      <ul class="timeline timeline-vertical py-20 max-w-2xl">
        <li>
          <div id='nextStep' class="timeline-end timeline-box timeline-additional-styling">Fill out the online form about your laboratory to start the process</div>
        ...
        <li>
          <hr />
          <div class="timeline-start timeline-box timeline-additional-styling timeline-additional-styling">The MSL Coordinator will initiate the registration of your laboratory via the FAST registration system. </div>
