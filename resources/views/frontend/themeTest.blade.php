    ...
    <div class="mainContentDiv">
        ...
        @php
            $bgTest = [
                'gap' => '0',
                'size' => '20',
                'bg-c' => ['bg-base-100', 'bg-neutral', 'bg-primary', 'bg-secondary'],
            ];
        @endphp
            ...
            @foreach ($bgTest['bg-c'] as $bgc)
                <div class="flex flex-row p-20 {{ $bgc }}">
                    ...
                    <div class="flex flex-col pl-6 pr-6 gap-{{ $bgTest['gap'] }}">
                        ...
                        <div class="bg-base-100 size-{{ $bgTest['size'] }}">
                            <p>bg-colour</p>
                        </div>
                    ...
                    <div class="flex flex-col pl-6 pr-6 gap-{{ $bgTest['gap'] }} ">
                        <p class="bg-primary     size-{{ $bgTest['size'] }} place-content-center text-center">primary
                        </p>
                    ...
                    <div class="flex flex-col pl-6 pr-6 gap-{{ $bgTest['gap'] }} ">
                        <p class="bg-secondary     size-{{ $bgTest['size'] }} place-content-center text-center">
                            secondary</p>
                    ...
                    <div class="flex flex-col pl-6 pr-6 gap-{{ $bgTest['gap'] }} ">
                        <p class="bg-neutral     size-{{ $bgTest['size'] }} place-content-center text-center">neutral
                        </p>
                    ...
                    <div class="flex flex-col pl-6 pr-6 gap-{{ $bgTest['gap'] }} ">
                        <p class="bg-success     size-{{ $bgTest['size'] }} place-content-center text-center">success
                        </p>
                    ...
                    <div class="flex flex-col pl-6 pr-6 gap-{{ $bgTest['gap'] }} ">
                        <p class="bg-warning     size-{{ $bgTest['size'] }} place-content-center text-center ">warning
                        </p>
