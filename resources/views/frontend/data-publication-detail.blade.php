                    ...
                    <div class="detail-entry-div !flex-col">
                        ...
                        @include('components.tab-list',[
                            'allTabs' => array(
                                ...
                                'Methods' => [
                                    'content' => $data['msl_description_methods'],
                                    'id' => 'msl_description_methods'
                                ],
                                'Other' => [
                                    'content' => $data['msl_description_other'],
                                    'id' => 'msl_description_other'
                                ],
                                'Series Information' => [
                                    'content' => $data['msl_description_series_information'],
                                    'id' => 'msl_description_series_information'
                                ],
                                'Content' => [
                                    'content' => $data['msl_description_table_of_contents'],
                                    'id' => 'msl_description_table_of_contents'
                                ],
                                'Technical Information' => [
                                    'content' => $data['msl_description_technical_info'],
                                    'id' => 'msl_description_technical_info'
                                ],
                            ),
