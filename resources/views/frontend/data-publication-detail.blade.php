                        ...
                        <div class="detail-entry-div">
                            ...
                            <div class="detail-entry-content">
                                @foreach ( $data->msl_creators as $creator)
                                    ...
                                    //names
                                    $dataList[] = $creator->getFullName();

                                    //creator type
                                    $dataList[] = implode(' ', preg_split('/(?=[A-Z])/', $creator->msl_creator_name_type));

                                    //affilitations
                                    $affiliationsCollected = [];
                                    foreach ($creator->affiliations as $affilitation){
                                        $affiliationsCollected[] = $affilitation->msl_creator_affiliation_name;
                                    }
                                    $dataList[] = implode(' | ', $affiliationsCollected);

                                    //name identifiers
                                    $identifiersCollected = [];
                                    foreach ($creator->nameIdentifiers as $identifier) {
                                        $identifiersCollected[] = $identifier->msl_creator_name_identifier;
                                    }
                                    $dataList[] = implode(' | ', $identifiersCollected);
                                @endphp
                            ...
                            <div class="detail-entry-content">
                                @foreach ( $data->msl_contributors as $contributor)
                                    @php
                                        ...
                                        //names
                                        $dataList[] = $contributor->getFullName();

                                        //creator type
                                        $dataList[] = implode(' ', preg_split('/(?=[A-Z])/', $contributor->msl_contributor_name_type));

                                        //affilitations
                                        $affiliationsCollected = [];
                                        foreach ($contributor->affiliations as $affilitation){
                                            $affiliationsCollected[] = $affilitation->msl_creator_affiliation_name;
                                        }
                                        $dataList[] = implode(' | ', $affiliationsCollected);
                                        ...
                                        //name identifiers
                                        $identifiersCollected = [];
                                        foreach ($contributor->nameIdentifiers as $identifier) {
                                            $identifiersCollected[] = $identifier->msl_creator_name_identifier;
                                        }
                                        $dataList[] = implode(' | ', $identifiersCollected);
                                    @endphp
                                    ...
                                    @foreach ( $data->msl_related_identifiers as $entry)
                                            @php
                                                ...
                                                if ($entry->msl_related_identifier_type == 'DOI') {
                                                    ...
                                                    if($entry->msl_related_identifier_type != ''){
                                                        $dataList[] = $entry->msl_related_identifier_type;
                                                    }

                                                    if($entry->msl_related_identifier_relation_type != ''){
