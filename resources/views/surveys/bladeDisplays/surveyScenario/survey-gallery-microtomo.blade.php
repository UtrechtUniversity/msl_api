<div>
    @include('components.gallery', [
        ...
        'descriptions' => array(
            "Isaac is a researcher at Cambridge UK. He is currently researching pressure solution in Mesozoic limestones in one specific location and developed a specific understanding of the deformation mechanisms involved. ThisS is based on his personal dataset, but has to be tested using a much wider set of data.",
