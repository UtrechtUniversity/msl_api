<div>
    @include('components.gallery', [
        ...
        'descriptions' => array(
            "Andrea is working on a designing an experiment, which needs to be presented to her supervisor",            
            ...
            "With the fine filter feature, she selects ranges in T and σ(n) to find the μ values of interest. She then proceeds to download the table.",           
