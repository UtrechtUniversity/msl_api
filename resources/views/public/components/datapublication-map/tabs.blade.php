<div id="sidebar-tabs" class=" flex flex-col flex-1 items-center py-5 gap-2 ">
    ...
    <div role="tablist" class="tabs tabs-box tabs-md flex flex-row justify-around bg-primary-100 rounded-none w-70">
        @foreach ($tabs as $tab)
    ...
    <div id='sidebar-content' class="w-70 bg-primary-100 flex-1 overflow-auto">
        @foreach ($tabs as $tab)
