        ...
        <div class="flex gap-2 min-h-[40px] flex-row justify-between w-full">
            <div class='flex-1  flex flex-col items-center justify-center '>
                ...
                <div class='flex flex-row gap-3'>
                    ...
                    <div class="py-4">
                        <button id='inside-filter-btn' class="menu-btn btn btn-md" disabled>
            ...
            <div class='flex-1  flex flex-col items-center justify-center'>
                ...
                <div class='flex flex-row gap-3'>
                    ...
                    <div class="py-4">
                        <button id='spatial-remove' class="menu-btn btn btn-md " disabled>Remove spatial filter</button>
                    </div>
                </div>
            </div>
        </div>
