...
<x-layout_main>
    <div class="main-content ">
        <div class="detail-div !bg-primary-100 limited-max-width-md">
            ...
            <p class="text-center ">
                Does your repository host data or models pertaining to one of the EPOS Multi-Scale Laboratories research
                domains?
            </p>
            <p class="text-center ">
                Would you like to make sure that these can be found on this catalogue, and on the EPOS data portal,
                alongside other European solid Earth scientific data?
            </p>
            <p class="text-center ">
            ...
            <p class="">First, we need to be able to identify which data publications you want to make discoverable
                within this catalogue. We currently support the following options:</p>
            ...
            <p class="">It might not be possible for us to exclusively filter your repository on MSL-relevant data
                publications. In that case we can filter the retrieved DOIs for MSL-relevancy by checking the metadata,
                as follows:</p>
            <ul class="list-disc pt-6 pb-6 pl-10 pr-10 ">
            ...
            <p class="">With that in mind, you make it a lot easier for us to find MSL-relevant data, if
                researchers publishing at your repository know what terms to add, to optimize data findability. See the
                below metadata recommendations on how to possibly go about that.</p>
            ...
            <ul class="list-disc pt-6 pb-6 pl-10 pr-10 ">
                ...
                <li>
                    Use keywords from the MSL vocabularies and include <abbr
                        title="Uniform Resource Identifier">URIs</abbr> to assigned terms.<br>
                    For specific implementation in the Datacite schema please see <a title="DataCite subjects metadata"
                        target="_blank"
                        href="https://datacite-metadata-schema.readthedocs.io/en/4.5/properties/subject/">here</a>.
                </li>
            </ul>
            ...
            <p class="">
                Every data repository has different technologies in place to share data. In addition to the above
                standard recommendations,
                each repository requires a unique approach for MSL to provide access to the data it hosts.
                To start developing this approach for your repository, please <a class="hover-interactive underline"
                    href="{{ route('contact-us') }}" title="contact us">contact us</a>.
            </p>
