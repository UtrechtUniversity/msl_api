        ...
        <div class="hidden md:block ">
            <div class="detail-div !bg-primary-100 ">
                ...
                <div class="max-w-(--breakpoint-lg) p-4">
                    <p class="pb-6">Here you can explore and select which Multi-Scale Labs keywords apply to your
                        research. When you’re done, you
                        can export the keywords you selected, so you know which words to assign when you’re making your
                        next data
                        publication. By adding terms like these (the more the better!), you make it much easier for us
                        to find your data
                        ...
                        <form method="post" action="{{ @route('keyword-export') }}"
                            ...
                            <div class="w-full ">
                                <div class="search-bar-container form-field-text">
                                    ...
                                    <input class="search-bar" type="text" id="search-input" name="query"
                                        placeholder="Search keywords..." />
                                    <div class="grid place-items-center h-full ">
                                        <button class="btn btn-primary mx-2 " type="button"
                                            id="button-add-custom-keyword">Add</button>
                                    </div>
                                </div>
                            </div>

                            <div class="flex p-6 w-full bg-primary-100">
                                <div class="w-1/2 flex overflow-hidden">
