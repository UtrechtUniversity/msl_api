    ...
    <div class="navbar bg-base-200 w-full z-40">
        <div class="navbar-start">
            ...
            <a href="{{ route('index') }}" class="btn btn-ghost ">
                <img src={{ asset('images/logos/MSL-logo-data-catalogue_1.png') }} alt="multi-scale-laboratories-logo"
                    class="max-h-full  max-w-fit min-[1100px]:block hidden">

                <img src={{ asset('images/logos/MSLsidewaysText.png') }} alt="multi-scale-laboratories-logo"
