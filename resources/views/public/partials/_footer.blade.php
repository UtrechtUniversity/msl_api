<footer class="footer sm:footer-horizontal bg-base-200 text-base-content p-10 justify-center gap-10">
    ...
    <aside class="justify-center content-center">
        <aside class="w-48">
            <img src={{ asset('images/logos/MSL.png') }} alt="MSL-logo" class="h-fit">
        </aside>
        <aside class="w-48 hover-interactive">
            <a class=" " href="https://www.epos-eu.org/">

                <img src={{ asset('images/logos/EPOScolour.png') }} alt="MSL-logo" class="w-48">
            </a>
            <p class="text-center">
