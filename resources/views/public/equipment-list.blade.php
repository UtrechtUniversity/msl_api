            ...
            <div class="drawer lg:drawer-open ">
                ...
                <div class="drawer-content bg-secondary-100 flex relative ">
                    ...
                    <div class="w-full min-h-full bg-primary-100 pl-4">
                        {{-- top search div --}}
                        @include('public.components.search-div-list', [
                            'searchFor' => 'equipment',
                            'amountFoundLabel' => 'Pieces',
                        ])
                        ...
                        <div class="list-view">
                            @if (count($result) > 0)
                                @foreach ($result as $equipment)
                                    @include('public.components.list-views.equipment', [
                                        'equipment' => $equipment,
                                    ])
                                @endforeach
                            @else
                                <h4 class="italic py-20">- no equipment pieces found -</h4>
                            @endif

                        </div>

                        <div class="list-view hidden">
                            @include('public.components.pagination')
                        </div>
                ...
                <div class="drawer-side z-40">
                    ...
                    <ul class="menu bg-primary-200 min-h-full p-0 w-80 text-primary-900">
                        ...
                        @include('public.components.search-div-filters', [
