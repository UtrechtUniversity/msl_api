...
<x-layout_main>
    <div class="main-content flex-col">
        ...
        <div class="sub-content">
            <p>this is sub content. Any child div with content must be in this one. It determines the responsive
                behaviour. As you can see it has a max width regardless on monitor width</p>
        </div>
        ...
        <div class="py-20 sub-content ">
            ...
            <p class="hover-interactive ">anthing that is interactive must have this utility class. Further
                implementation can be read under links: group-hover</p>
            <p>Assumption: our users have various degrees of tech literacy and it is important to make interactive
                elements explicit</p>
        </div>
        ...
        <div class="pt-20 sub-content">
            <h2>Links</h2>
            <div class="flex items-center flex-col">
                <a href="">Links like this do not have an underline, because the buttons in nav and elsewhere are
                    wrapped as such</a>
            ...
            <div class="flex items-center justify-center">
                <p>
                    This is a link <a href="" class="hover-interactive underline">with interactive utility</a>,
                    which works well in a text
                </p>
            </div>
            ...
            <div>
                ...
                <p class="pt-4">The "group" marker is not an utility and cannot be used with "@apply" in the "@layer
                    base" in css. So the "group"
                    as a class must be called extra. this results to the desired behaviour that the child is marked
                    interactive when the "a" tagged container is hovered.
                    Try yourself</p>
                <div class="flex items-center justify-center">
                    <a href="" class="group">
                        parent -----
                ...
                <p class="pt-4">When an "a" tag is used it could have more invisible free space when hovered, which is
                    undesireable behaviour. Like here:</p>
                <div class="flex items-center justify-center">
                    <a href="" class="hover-interactive ">parent ----- <div class="inline-block underline">This
                            is the child</div> ----- parent</a>
                </div>

                <p class="pt-4">If the child element has the interactive class it is not clear that an interaction is
                    possible until the child is hovered. This is also undesireable. Like here:</p>
                <div class="flex items-center justify-center">
                    <a href="" class="">parent ----- <div class="inline-block hover-interactive">This is
                            the child</div> ----- parent</a>
                </div>
        ...
        <div class="sub-content bg-primary-200">
            ...
            <div class="bg-primary-100 h-90 m-10">
                ...
                <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Beatae iste ea repellat hic repudiandae aut
                    vel corporis sunt officia sed atque perferendis, adipisci labore? Est soluta eum natus doloremque
                    iure.</p>
            </div>
            ...
            <div class="bg-primary-300 h-90 m-10">
                ...
                <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eveniet commodi exercitationem eaque nisi
                    odit nostrum beatae, voluptatibus tempore rerum totam hic debitis? Illum at vel illo nemo porro
                    natus soluta.</p>
            </div>
        </div>
        <div class="sub-content bg-secondary-200 text-secondary-900">
            <h3>secondary (for admin pages)</h3>
            <h4>other use cases need to be explored. It could be that it might be useful for highlighting certain info
        ...
        <div class="sub-content  bg-primary-200 w-full p-10">
            ...
            <div class="word-card-parent bg-primary-100">
                ...
                <div class="word-card">without width limit it can actually take a lot of space, better avoid by using
                    component below</div>
            </div>
            <br>
            ...
            <div class="word-card-parent bg-primary-100 h-40">
                ...
                @include('public.components.word-card', [
                    'word' =>
                        'extreme length Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quos eligendi numquam voluptatum quaerat vel qui eveniet! Earum voluptas, deleniti debitis numquam aperiam inventore nobis, explicabo accusamus nisi eius animi consequuntur.',
                ])
                @include('public.components.word-card', [
                    'word' => 'this is a word',
                ])
        ...
        <div class="sub-content">
            ...
            @include('public.components.tab-list', [
                'allTabs' => [
                    'First Tab' => [
                        'content' =>
                            'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Rem harum perspiciatis eum laboriosam nostrum ipsam perferendis quae aspernatur itaque recusandae aut, totam ea sit sapiente numquam voluptatem molestiae ducimus unde.',
                        'id' => 'id1',
                    ],
                    'Second Tab' => [
                        'content' =>
        ...
        <div class="sub-content h-90 bg-primary-200 w-full p-4">
            ...
            <div class="hidden md:block m-4 bg-primary-100">
                <p>to be coupled with a div which should not be visible on small screen. like this one for example.
                    Reduce the screen size to see.
                    The classes in this div are required for it to work. note the same breakpoint as for the component
                    above</p>
            </div>
        </div>
