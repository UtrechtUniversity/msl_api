<div>
    @include('public.components.gallery', [
        ...
        'descriptions' => [
            ...
            "The first model failed due to too coarse sand not allowing the detailed structures Charlie needs for her analysis to form, but she initially thinks it's due to improper sieving. This time she follows a strict sieving protocol setting up the analogue model.",
