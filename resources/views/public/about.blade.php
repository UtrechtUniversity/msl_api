    ...
    <div class="main-content ">
        ...
        <div class="detail-div !bg-primary-100">
            ...
            <div class="detail-entry-div place-items-center !flex-col">
                ...
                <img src={{ asset('images/heros/about_smallest.png') }} alt="aboutImage"
                ...
                <div class="max-w-(--breakpoint-lg) flex flex-col md:flex-row sm:p-10 py-10  gap-6">
                    <div class="w-full card bg-base-200 shadow-xl p-4 flex flex-col justify-start ">
                        <h4>Our Vision</h4>
                ...
                <div class="max-w-(--breakpoint-md) pt-10 sm:pt-20">
                    ...
                    <p class="inline">
                        In a world that demands increasing collaboration within the scientific community, solid Earth
                        science laboratories are challenged with finding each other
                        to exchange best practices and re-use data. Data produced by the EPOS Multi-Scale Laboratories
                        are crucial to serving society’s needs for geo-resources exploration
                        and for protection against geo-hazards. Indeed,
                    <p class="font-bold inline">to model Earth system behavior during human or tectonic forcing</p>, we
                    need to understand the governing processes and
                    properties from the molecule scale to the scale of the operating system. Therefore, coordination and
                    communication inside the European solid Earth science laboratories,
                    complemented with services to increase curation and access for re-use of laboratory data is needed
                    to effectively contribute to solve the grand challenges facing society.
                    </p>
                    <h3 class="pb-2 pt-6">What is EPOS MSL?</h3>
                    <p class="inline">
                        EPOS Multi-Scale Laboratories includes a wide range of world-class laboratories, aimed at
                        studying the
                    <p class="font-bold inline">properties and processes controlling rock system behaviour</p>.
                    The length scales addressed by these infrastructures cover the nano- and micrometre levels (electron
                    microscopy and micro-beam analysis) to the scale of experiments
                    ...
                    <p>
                        EPOS MSL collects and harmonizes available and emerging laboratory (meta)data, aiming to
                        generate data products that are easily Findable, Accessible,
                        Interoperable and Re-usable (FAIR) for future research, notably into Geo-resources,
                        Geo-storage, Geo-hazards and Earth System Evolution. Data emerging from MSL labs can be
                        categorized as below, following the six major sub-domains below.
                    </p>
                </div>
                ...
                <h6 class="italic">- hover for more details -</h6>

                <div
                    class="sm:max-w-(--breakpoint-lg) flex md:flex-row flex-wrap sm:p-10 py-10 gap-4 justify-center place-items-center">
                    @foreach ($infoList as $infoElement)
                        <div class="dropdown dropdown-hover p-4">
                            <div tabindex="0" role="button"
                                class="m-1 p-4 bg-base-200 rounded-lg w-64 h-24 place-content-center border-2 border-primary-500 hover:border-info-500">
                                <h5 class="text-base font-normal">{{ $infoElement['name'] }}</h5>
                            </div>

                            <ul tabindex="0"
                                class="dropdown-content menu bg-info-200 text-info-900 rounded-box z-1 p-2 shadow-xl w-64 list-disc">
                ...
                <div class="max-w-(--breakpoint-lg) flex flex-col md:flex-row sm:p-10 gap-6 justify-center">
                    <div class="w-full card bg-base-200 shadow-xl p-4 flex flex-col justify-center md:w-2/3">
                        ...
                        <p class="sm:px-10">MSL data can be found in the MSL data catalogue on this dedicated website,
                            and in the <a class="hover-interactive underline"
                                href="https://www.epos-eu.org/dataportal">EPOS data portal</a>,
