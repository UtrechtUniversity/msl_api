    ...
    <section class="">
        <div class="px-4 mx-auto max-w-(--breakpoint-md)">
            ...
            <form method="POST" action="{{ route('laboratory-intake-process') }}" class="space-y-4" novalidate>
                ...
                @include('public.forms.components.freeText', [
                ...
                <div class="flex flex-col w-full gap-4">
                    ...
                    <div class="flex flex-row w-full gap-4">
                        @include('public.forms.components.freeText', [
                            ...
                            'title' => 'Website',
                            'placeholder' =>
                                'Provide an active weblink/URL to your laboratory. Format example: https://www.nameofwebsite.com',
                        ])
                    </div>
                ...
                <div>
                    <p class="text-left p-0 py-4">This laboratory description will be shown on the TCS MSL catalogue
                        webpage
                    ...
                    @include('public.forms.components.freeText', [
                        ...
                        'placeholder' =>
                            'Provide a short, concise description of your laboratory (max. 4000 characters). Please include description of its research activities and/or focus. You can include a global description of the equipment in your laboratory',
                        'textBlock' => true,
                    ])
                </div>
                ...
                <div>
                    <p class="text-left py-4">Please select one
                        <a href={{ route('about') }}>subdomain</a> under which your laboratory fits best
                    </p>
                    <div class="w-full px-8">
                        @include('public.forms.components.dropDownSelect', [
                    ...
                    <div class="flex flex-col gap-2 pb-6 bg-white  rounded-lg ">
                        <div
                            class="flex flex-col px-10 py-8
                        {{-- custom error message --}}
                         @if ($errors->has('dataSharing-facilityAccess')) error-highlight bg-error-300 text-error-700 rounded-md @endif
                        ">
                            <div class="w-1/2 self-center bg-primary-100 rounded">
                                @include('public.forms.components.checkBox', [
                                    'sectionName' => 'dataSharing-facilityAccess',
                                    'showErrMess' => true,
                                    'ElementsArray' => ['Facility Access and Data sharing'],
                                ])
                            </div>
                        ...
                        <div class="flex flex-row gap-10 bg-white rounded-md px-4">
                            ...
                            <div class="w-full">
                                <p class="text-justified">
                                    ...
                                    You use MSL-harmonized vocabulary terms as metadata/keywords in publishing your
                                    data.
                                </p>
                ...
                <div class="flex flex-col w-full gap-4">
                    ...
                    <div class="w-full">
                        @include('public.forms.components.dropDownSelect', [
                            ...
                            'ElementsArray' => ['Female', 'Male', 'Other'],
                        ])
