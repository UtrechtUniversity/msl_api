            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <a class="btn btn-primary" href="{{ route('filter-tree-download') }}">Download tree with interpreted
                            keywords</a>
                        <a class="btn btn-primary" href="{{ route('filter-tree-download-original') }}">Download tree with
