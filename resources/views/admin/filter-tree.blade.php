        ...
        <div class="row justify-content-center">
            <div class="col-md-10">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <p>Download generated export of data used by portal to display filter menu in search
                            results.</p>
                        <a class="btn btn-primary" href="{{ route('filter-tree-download') }}">Download tree with
                            interpreted
                            keywords</a>
