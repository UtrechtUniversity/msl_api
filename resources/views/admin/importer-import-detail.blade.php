    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-10">
                <div>
                    <a
                        href="{{ route('importer-imports-flow', ['importer_id' => $importer_id, 'import_id' => $import_id]) }}">Back
                        to import results</a>
                </div>
                            ...
                            <div id="collapse-source-dataset" class="collapse">
                                <div class="card-body">
                                    ...
                                    <div class="overflow-scroll">
                                        <pre>{{ $sourceDataset->source_dataset }}</pre>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mt-3">
                            ...
                            <div id="collapse-dataset-create" class="collapse">
                                <div class="card-body">
                                    ...
                                    <p>Dataset:</p>
                                    <div class="overflow-scroll">
                                        <pre>{{ $datasetCreate->getDatasetAsJson(true) }}</pre>
                                    </div>
                                    <br>
                                    <p>Response:</p>
                                    <div class="overflow-scroll">
                                        <pre>{{ $datasetCreate->getResponseBodyAsJson(true) }}</pre>
                                    </div>
                                </div>
                            </div>
                        </div>
