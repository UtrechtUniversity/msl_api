...
class ExcelSheetColumnDescriptions implements FromArray, WithHeadings, WithMapping, WithTitle
{
    protected $descriptionsMapped = [
        ...
        ['columnName' => 'contributor_definition', 'columnDescription' => '!!!This is a temporary field!!! Definition of the term given by a contributor like you working in this excel sheet. This data should be transferred to other columns, like "external_uri" or "hyperlink"'],
        ['columnName' => 'contributor_definition_link', 'columnDescription' => '!!!This is a temporary field!!! Definition of the term given by a contributor like you working in this excel sheet. This data should be transferred to other columns, like "external_uri" or "hyperlink"'],
