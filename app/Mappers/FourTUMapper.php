...
class FourTUMapper
{
    ...
    public function map(SourceDataset $sourceDataset)
    {
        ...
        // STEP 2: Geo handling - extract geo locations as text and try to find spatial coordinates
...
//                }
        ...
        // GEO spatial handling - final step: Pass all the collected geo data of the previous 2 steps
