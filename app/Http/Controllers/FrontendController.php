...
class FrontendController extends Controller
{
    ...
    public function dataPublications(Request $request)
    {
        ...
        return view('frontend.data-access', ['facets' => $result->getFacets(),'allResultsCount' => $result->getTotalResultsCount(),'result' => $result->getResults(true), 'paginator' => $paginator, 'activeFilters' => $activeFilters, 'activeFiltersFrontend' => $activeFiltersFrontend, 'sort' => $sort, 'queryParams' => $request->query()]);
    }
